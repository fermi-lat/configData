...
public :
  ...
  virtual Bool_t   compare(ConfigBase& one, ConfigBase& other, TList& l,
...
protected:
  ...
  Bool_t compareV2(const char* name, UInt_t* val1, UInt_t* val2, int size1, int size2,  TH1* h = 0, TH1* hv = 0, Bool_t onlyOne=kTRUE);
  Bool_t compareV2(const char* name, UShort_t* val1, UShort_t* val2, int size1, int size2,  TH1* h = 0, TH1* hv = 0, Bool_t onlyOne=kTRUE);
